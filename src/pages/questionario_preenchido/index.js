    ...
    const template = `
        <div class="container my-2">
            <div class="component_layout component_questionário">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="escolaridade" id="pos_doutorado" value="7" checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="admissao_escolaridade" id="admissao_superior" value="3" checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="conhecimento_lingua_inglesa" id="conhecimento_lingua_inglesa" value="1" checked>
                    <label class="form-check-label" for="conhecimento_lingua_inglesa">
                        Inglês
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="conhecimento_lingua_espanhola" id="conhecimento_lingua_espanhola" value="1" checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="beneficio_bolsa" id="beneficio_bolsa_sim" value="1" checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="frequentou_cursos" id="frequentou_cursos_nao" value="0" checked>
